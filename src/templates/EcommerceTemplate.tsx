 ...
 * 
 * Minimal Japanese-style template with clean header and footer
 */
    ...
    <div className={`bg-primary text-primary-foreground py-12 ${footerClassName}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="mb-4">
              <h3 className="text-lg font-medium">Pet Wellness</h3>
            </div>
            <p className="text-primary-foreground/70 text-sm">
              Premium nutrition and supplements for your beloved pets
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-primary-foreground/20 text-center text-primary-foreground/70 text-sm">
          <p>&copy; 2024 Pet Wellness Store. Crafted with care.</p>
        </div>
      </div>
    </div>
  )
