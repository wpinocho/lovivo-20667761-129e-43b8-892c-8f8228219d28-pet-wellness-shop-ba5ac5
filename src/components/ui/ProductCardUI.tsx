 ...
 * 
 * Minimal Japanese-style product card with clean design
 */
...
export const ProductCardUI = ({ product }: ProductCardUIProps) => {
  return (
    <HeadlessProductCard product={product}>
      {(logic) => (
        <Card className="group bg-card hover:shadow-lg transition-shadow duration-300 border border-border/50">
              ...
              <div className="aspect-square bg-muted rounded mb-3 overflow-hidden relative">
                ...
                <div className="absolute top-2 left-2 flex flex-col gap-1">
                  ...
                  {logic.product.featured && (
                    <span className="bg-accent text-accent-foreground text-xs px-2 py-1 rounded-sm font-medium">
                      Premium
                    </span>
                  )}
                  {!logic.inStock && (
                    <span className="bg-muted-foreground text-background text-xs px-2 py-1 rounded-sm font-medium">
                      Out of stock
                    </span>
                  )}
                </div>
